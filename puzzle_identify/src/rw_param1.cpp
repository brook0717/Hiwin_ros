...
int main( int argc, char ** argv ) 
{
    ...
    // 輸出與載入設定好的參數
    system("rosparam dump /home/jack/hello_ws/src/turtle_control/config/data.yaml");
    system("rosparam load /home/jack/hello_ws/src/turtle_control/config/data.yaml");
